  ...
  return (
    <main className="simulationLab">
      <header className="simulationLabHeader">
        <h1 className="simulationLabTitle">Simulation Lab</h1>
        <p className="simulationLabSubtitle">
          Test financial decisions with interactive scenarios and see the 5 year
          impact!
        </p>
      </header>
      ...
      <section className="simulationLabCardContainer">
        <SimulationLabCard
          ...
          to="/simulation/property-vs-renting"
          ready={true}
        />
        <SimulationLabCard
        ...
        <SimulationLabCard
          ...
          to="/simulation/local-vs-offshore"
          ready={true}
        />
        <SimulationLabCard
      ...
      <section className="insights">
        <h1 className="insightsTitle">Quick Insights from the Lab</h1>
