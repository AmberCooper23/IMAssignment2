    ...
    <main>
      <header className="hero">
        ...
        <figure className="heroImage">
          <img
            src={heroImage}
            alt="Rooftop view of buildings in Johannesburg during a sunset, orange sky."
          />
        </figure>
      </header>

      <h2 className="bannerTitle">Your Wealth-Building Journey</h2>
      <p className="bannerText">
        Transform finance from overwhelming to engaging with our three core
        pillars!
      </p>
      ...
      <section className="contextSection">
        ...
        <section className="contextContent">
          ...
          <p className="contextText">
            From SARS tax brackets to TFSA limits, property markets in JHB and
            CPT, to offshore investment controls - we speak your language.
          </p>
          <ul className="contextCriteria">
            <li className="contextCriteriaContainer">
              <h4 className="contextCriteriaTitle">SARS Tax Optimised</h4>
              <p className="contextCriteriaSubtitle">
                RA & medical aid benefits
              </p>
            </li>
            <li className="contextCriteriaContainer">
              <h4 className="contextCriteriaTitle">TFSA Tracking</h4>
              <p className="contextCriteriaSubtitle">
                R36k annual, R500k lifetime
              </p>
            </li>
          </ul>
          <ul className="contextCriteria">
