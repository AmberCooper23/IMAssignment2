...
function StrategyTrackCard({ strategyTrack, archetype, description, priorities, milestones, className, to }) {
    return (
        <article className="stratTrackCard">
            ...
            <div className="stratTrackCardContent">
                ...
                <h4 className="heading">Priorities:</h4>
                <ul className="stratTrackCardPriorities">
                    {priorities.map((priority, index) => (
                        <li key={index}>{priority}</li>
                    ))}
                </ul>
                <h4 className="heading">5 Year Milestones:</h4>
